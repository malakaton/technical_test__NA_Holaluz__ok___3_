 ...
 */
class App_src_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.App\\Electricity\\MeterReader\\EntryPoint\\UI\\Command\\MeterReaderCommand' => 'getMeterReaderCommandService',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/App_src_KernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'App_src_KernelTestDebugContainer',
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Electricity\\MeterReader\\EntryPoint\\UI\\Command\\MeterReaderCommand',
            ],
        ];
    }
